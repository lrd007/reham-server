...
<body class="authentication-bg authentication-bg-pattern">
                    ...
                    <div class="card bg-pattern">
                        <div class="card-body p-4">
                            <div class="text-center w-75 m-auto">
                                ...
                                <p class="text-muted mb-4 mt-3">1Enter your email address and password to access panel1.
                                </p>
                            </div>
    ...
    <footer class="footer footer-alt">
        ...
        </script> &copy; Powered by <a href="https://reham.com" class="text-white-50">Reham</a>
    </footer>
