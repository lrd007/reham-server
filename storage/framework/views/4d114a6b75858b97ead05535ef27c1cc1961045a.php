...
<html lang="en">
    <head>
        <?php echo $__env->make('layouts.shared.title-meta', ['title' => "Error Page | 404 | Page not Found"], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <body class="authentication-bg authentication-bg-pattern">
                    ...
                    <div class="col-lg-5">
                        ...
                        <div class="row mt-3">
                            <div class="col-12 text-center">
                                <p class="text-white-50">Return to <a href="<?php echo e(route('index')); ?>" class="text-white ml-1"><b>Home</b></a></p>
                            </div> <!-- end col -->
                        </div>
                        <!-- end row -->
        ...
        <footer class="footer footer-alt">
            <script>document.write(new Date().getFullYear())</script> &copy; Powered by <a href="https://reham.com" class="text-white-50">Reham</a>
        </footer>
        <?php echo $__env->make('layouts.shared.footer-script', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </body>

</html>
<?php /**PATH D:\Work Space\Reham\server\resources\views/errors/404.blade.php ENDPATH**/ ?>