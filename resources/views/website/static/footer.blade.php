        ...
        <div class="row">
            <div class="col-md-6 footer-right d-flex align-items-center">
                <div class="footer__logo">
                    <img src="{{ asset('assets/dexter/src/images/reham-logo-arabic-white.png') }}" class="img-fluid" alt="logo">
                </div>
                <p class="copy-right">
                    جميع الحقوق محفوظة
                    Reham © {{ date('Y') }} &nbsp;
            ...
            <div class="col-md-6 footer-left d-flex justify-content-end">
                <ul class="list-unstyled footer__items cen-row">
                    <li class="footer__item">
                        <a href="{{route('legal_faq')}}" class="footer__link">
                            سياسية الخصوصية
                        </a>
                    </li>
                    <li class="footer__item">
...
<script src="{{ asset('assets/dexter/javascript/components/sidebar-main.js') }}"></script>
<script src="{{ asset('assets/dexter/javascript/bootstrap.bundle.js') }}" ></script>
<script src="{{ asset('assets/dexter/javascript/bootstrap.js') }}" ></script>
